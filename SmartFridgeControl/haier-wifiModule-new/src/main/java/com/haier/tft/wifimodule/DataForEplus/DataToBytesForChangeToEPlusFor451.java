...
/**
 * 451通讯协议
* @ClassName: DataToBytesForChangeToEPlusFor451 
* @date 2016-2-26 下午6:32:36 
* @Description 
* 451WDVZU1 设备typeid
  "111c120024000810010200618002834500000000000000000000000000000000";
*
 */
public class DataToBytesForChangeToEPlusFor451 extends
	...
	public byte[] getBytesForReportState(byte[] sendData, byte[] GoodFoodData,byte[] UVData,
		...
		ePlusData[16] = sendData[13];// 冷冻档位设置
