...
//        protocolConfig.add(new ProtocolConfigBase("111c12002400081001030061800118420000000000", 0, 0, 0));//type id
        ...
        protocolConfig.add(new ProtocolConfigBase(EnumBaseName.fridgeTargetTemp.name(), 0, 13, 8, 2, 10, 0));//冷藏目标温度
        protocolConfig.add(new ProtocolConfigBase(EnumBaseName.freezeTargetTemp.name(), 0, 14, 8, -24, -16, 26));//冷冻目标温度
        protocolConfig.add(new ProtocolConfigBase(EnumBaseName.changeTargetTemp.name(), 0, 15, 8, -18, 5, 21));//变温目标温度
        ...
        protocolConfig.add(new ProtocolConfigBase(EnumBaseName.envTempSensorErr.name(), 1, 30, 0));//环境温度传感器故障
        protocolConfig.add(new ProtocolConfigBase(EnumBaseName.fridgeSensorErr.name(), 1, 30, 1));//冷藏温度传感器故障
        protocolConfig.add(new ProtocolConfigBase(EnumBaseName.freezeSensorErr.name(), 1, 30, 3));//冷冻温度传感器故障
        protocolConfig.add(new ProtocolConfigBase(EnumBaseName.changeSensorErr.name(), 1, 30, 4));//变温温度传感器故障
        protocolConfig.add(new ProtocolConfigBase(EnumBaseName.defrostSensorErr.name(), 1, 29, 0));//化霜传感器故障
        protocolConfig.add(new ProtocolConfigBase(EnumBaseName.freezeDefrostErr.name(), 1, 29, 6));//冷冻化霜故障
