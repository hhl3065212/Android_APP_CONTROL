...
public class CrashHandler implements UncaughtExceptionHandler {
	...
	public static final String DESCRIPTOR = "com.haier.smartfridgecontrol";
	...
	private Class<? extends Service> mLaunch;
	 ...
	 * @param ctx
	 */
	public void init(Context ctx, Class<? extends Service> launch, AppCrashCallBack callback) {
		 mContext = ctx;
		mLaunch = launch;
        mCallback = callback;
